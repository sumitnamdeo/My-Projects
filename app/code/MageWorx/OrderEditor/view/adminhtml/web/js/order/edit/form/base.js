...
define(
    ...
    function ($, $t) {
        ...
        $.widget('mage.mageworxOrderEditorBase', {
            ...
            editLinkTemplate: '<div id="%block_id%" class="actions block-edit-link"><a href="#">Edit</a></div>',
            ...
            _initloadEditForm: function () {
                ...
                $(document).on('click touchstart', this.params.editLinkId, function () {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (!response.error && response.status == true) {
                                ...
                                fieldsetParent.children(self.params.blockContainerId).addClass('ordereditor-hidden-fieldset').hide();
                                fieldsetParent.children(self.params.blockContainerId).after("<div class='" + self.params.blockContainerId.substring(1) + " ordereditor-fieldset'></div>");
